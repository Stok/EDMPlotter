...
function plotData(svgId, data) {
    ...
    var bisectx_val = d3.bisector(function(d) {
        return d.x_val;
    }).left;
    ...
    function updatePlot(data) {
        ...
        function mousemove() {
            ...
            var x0 = xScale.invert(d3.mouse(this)[0]),
                /* d3.mouse(this)[0] returns the x position on the screen of the mouse. xScale.invert function is reversing the process that we use to map the domain (x_val) to range (position on screen). So it takes the position on the screen and converts it into an equivalent x_val! */
